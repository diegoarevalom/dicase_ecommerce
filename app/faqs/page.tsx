...
function page() {
  return (
    <div className="flex flex-col items-center justify-center h-screen  bg-[#E8E8E8] dark:bg-[#333]">
      <h1 className='text-4xl font-bold mb-4 py-6 text-black dark:text-white'>PREGUNTAS FRECUENTES</h1>
      <div className='flex flex-col align-between gap-6'>
        <span className='flex justify-between items-center bg-[#DDD0C8] dark:bg-[#222] text-black dark:text-white text-xl rounded-md'>¿Cuánto demora el envio?</span>
        <span className='flex justify-between items-center bg-[#DDD0C8] dark:bg-[#222] text-black dark:text-white text-xl rounded-md'>¿Cómo puedo saber si un suplemento es adecuado para mí?</span>
        <span className='flex justify-between items-center bg-[#DDD0C8] dark:bg-[#222] text-black dark:text-white text-xl rounded-md'>¿Puedo cambiar o devolver el producto?</span>
        <span className='flex justify-between items-center bg-[#DDD0C8] dark:bg-[#222] text-black dark:text-white text-xl rounded-md'>¿Qué métodos de pago aceptan?</span>
      </div>
      <div className='grid grid-cols-2 gap-2 mt-4'>
        ...
        <div className='flex flex-col gap-2 bg-white dark:bg-[#222] p-6 rounded-lg shadow-md min-h-[180px] max-w-[350] justify-between'>
          ...
          <span className='self-start mt-auto'><a href="#" className="text-blue-600 dark:text-blue-400 hover:underline flex items-center gap-1">Ver más <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M9 5l7 7-7 7"></path></svg></a></span>
        </div>
        ...
        <div className='flex flex-col gap-2 bg-white dark:bg-[#222] p-6 rounded-lg shadow-md min-h-[180px] max-w-[350] justify-between'>
          ...
          <span className='self-start mt-auto'><a href="#" className="text-blue-600 dark:text-blue-400 hover:underline flex items-center gap-1">Ir a Soporte <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M9 5l7 7-7 7"></path></svg></a></span>
        </div>
        ...
        <div className='flex flex-col gap-2 bg-white dark:bg-[#222] p-6 rounded-lg shadow-md min-h-[180px] max-w-[350] justify-between'>
          ...
          <span className='self-start mt-auto'><a href="#" className="text-blue-600 dark:text-blue-400 hover:underline flex items-center gap-1">Leer Términos <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M9 5l7 7-7 7"></path></svg></a></span>
        </div>
        ...
        <div className='flex flex-col gap-2 bg-white dark:bg-[#222] p-6 rounded-lg shadow-md min-h-[180px] max-w-[350] align-between'>
          ...
          <span className='self-start mt-auto'><a href="#" className="text-blue-600 dark:text-blue-400 hover:underline flex items-center gap-1">Leer Política <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M9 5l7 7-7 7"></path></svg></a></span>
        </div>
